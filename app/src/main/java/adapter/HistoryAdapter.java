...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    private ArrayList<history> mDate;

    public HistoryAdapter(Context context, ArrayList<history> mDate){
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.mTvName.setText(""+mDate.get(position).getName());
        holder.mTvInfo.setText(""+mDate.get(position).getInfo());
        holder.mTvType.setText(""+mDate.get(position).getType());
