...
import utis.DownloadOpenFile;
import utis.TimeUtil;
...
public class DownloadFileListAdapter extends BaseAdapter implements OnRetryableFileDownloadStatusListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cacheConvertView == null) {
            cacheConvertView = View.inflate(parent.getContext(), R.layout.fragment__item_download, null);
...
//        CheckBox cbSelect = (CheckBox) cacheConvertView.findViewById(R.id.cbSelect);
        ImageView mImgDel=(ImageView) cacheConvertView.findViewById(R.id.img_delete);
...
//                tvDownloadSize.setText("");
        ...
        mImgDel.setOnClickListener(new OnClickListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                if (curDownloadFileInfo != null) {
                    switch (curDownloadFileInfo.getStatus()) {
                        // download file status:unknown
                        case Status.DOWNLOAD_STATUS_UNKNOWN:
                            showToast("未知错误:" + curDownloadFileInfo
...
//                                tvDownloadSize.setText("");
                            ...
                            Intent openFile = DownloadOpenFile.openFile(curDownloadFileInfo.getFilePath());
