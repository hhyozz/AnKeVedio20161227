...
public class FastBlurs extends BitmapTransformation {
    ...
    public static class Builder {
        ...
        public FastBlurs build() {
            return new FastBlurs(mContext, mRadius, mColor);
        }
     ...
     */
    public FastBlurs(Context context, @FloatRange(from = 0.0f) float radius, int color) {
        super(context);
        mContext = context;
     ...
     * @param radius  The blur's radius.
     */
    public FastBlurs(Context context, @FloatRange(from = 0.0f) float radius) {
        this(context, radius, Color.TRANSPARENT);
    }

    public FastBlurs(Context context) {
